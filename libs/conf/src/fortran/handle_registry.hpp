#ifndef CONF_FORTRAN_HANDLE_REGISTRY_HPP
#define CONF_FORTRAN_HANDLE_REGISTRY_HPP
...
/// Fortran code to reference C++ objects (Config) via opaque integer tokens
/// without exposing raw pointers across the language boundary.
///
/// Token 0 is reserved as the invalid handle sentinel (CONF_HANDLE_INVALID).
...
/// Token 0 is reserved as invalid (CONF_HANDLE_INVALID). Tokens are never
