...
TEST(CoastalRenormalization, RenormalizationAndExtrapolation) {
    ...
    src_mesh = topology::UnstructuredMesh<MemSpace>(
        src_mesh.node_coords_view(),
        src_mesh.conn_offsets_view(),
        src_mesh.conn_indices_view(),
        src_mesh.coord_system(),
        src_mesh.cell_areas_view(),
        src_mask
    );
    ...
    topology::StructuredGrid<MemSpace> dst_grid(
        dst_ni, dst_nj, dst_cx, dst_cy, topology::CoordinateSystem::SphericalDeg);
    ...
    dst_corners_lon(0) = 0.7; dst_corners_lat(0) = 0.7;
    dst_corners_lon(1) = 1.7; dst_corners_lat(1) = 0.7;
    dst_corners_lon(2) = 1.7; dst_corners_lat(2) = 1.7;
    dst_corners_lon(3) = 0.7; dst_corners_lat(3) = 1.7;
    ...
    topology::StructuredGrid<MemSpace> dry_dst_grid(
        dst_ni, dst_nj, dry_cx, dry_cy, topology::CoordinateSystem::SphericalDeg);
    ...
    dry_corners_lon(0) = 2.5; dry_corners_lat(0) = 2.5;
    dry_corners_lon(1) = 3.5; dry_corners_lat(1) = 2.5;
    dry_corners_lon(2) = 3.5; dry_corners_lat(2) = 3.5;
    dry_corners_lon(3) = 2.5; dry_corners_lat(3) = 3.5;
