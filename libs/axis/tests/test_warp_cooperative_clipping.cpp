...
clip_spherical_polygon_cooperative(
    const TeamMember& team,
    const double*     src_x, const double* src_y, std::size_t n_src,
    ...
    Kokkos::parallel_reduce(Kokkos::TeamThreadRange(team, n_dst),
...
TEST(WarpCooperativeTest, ParallelClippingEquivalence) {
    ...
    Kokkos::parallel_for("WarpCooperativeClipperTest", policy,
