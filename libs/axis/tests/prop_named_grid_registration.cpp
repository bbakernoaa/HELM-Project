...
RC_GTEST_PROP(PropNamedGridRegistration, RegisteredGribGridsParseCorrectly, ()) {
    const std::vector<int> registered_numbers = {
        87, 88, 90, 91, 92, 130, 132, 138, 139, 140, 145, 146, 147, 148, 150,
        151, 160, 163, 179, 184, 187, 188, 189, 197, 198, 200, 201, 202, 203,
        205, 206, 207, 209, 211, 212, 213, 214, 215, 216, 217, 218, 219, 220,
        221, 222, 223, 224, 226, 227, 236, 237, 240, 241, 242, 245, 246, 247,
        249, 252
    };
