...
static topology::UnstructuredMesh<MemSpace> make_regular_spherical_grid(std::size_t ni, std::size_t nj, double lon_min, double lon_max, double lat_min, double lat_max) {
