...
public:
    ...
    constexpr Time_Window(Time_Point start, Duration duration)
        : Time_Window{start, start + duration}
    {}
    ...
    [[nodiscard]] constexpr Time_Point start() const noexcept { return start_; }
    [[nodiscard]] constexpr Time_Point end() const noexcept { return end_; }
